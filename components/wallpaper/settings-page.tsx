...
import { Trash2, Bell, Shield, HelpCircle, ChevronRight, Download, Heart, FolderPlus } from "lucide-react";
...
export function SettingsPage() {
  ...
  const [isClearCacheOpen, setIsClearCacheOpen] = React.useState(false);
      ...
      <Dialog open={isClearCacheOpen} onOpenChange={setIsClearCacheOpen}>
        <DialogContent className="max-w-[90%] rounded-2xl">
          <DialogHeader>
            ...
            <DialogDescription>
              This will remove all cached images. Your favorites and collections will not be affected.
            </DialogDescription>
          </DialogHeader>
